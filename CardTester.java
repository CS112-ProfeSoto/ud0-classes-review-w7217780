...
public class CardTester {
	 ...
	 * 
	 * System.out.
	 * println("If no default constructor built, should get [0 ] and toString gives: ["
	 * + test.toString() + "]. Know why?");
	 * System.out.
	 * println("Otherwise, the above should show the default value of: A " +
	 * Card.DEFAULT_SUIT);
	 * }
	 */
	 ...
	 * System.out.println("setValue should have changed value only to 2: " + test +
	 * ". Setter returned " + setterTest);
	 * 
	 * setterTest = test.setValue(10);
	 * System.out.println("setValue should have changed value only to 10: " + test +
	 * ". Setter returned " + setterTest);
	 * 
	 * setterTest = test.setValue(11);
	 * System.out.println("setValue should have changed value only to J: " + test +
	 * ". Setter returned " + setterTest);
	 * 
	 * setterTest = test.setValue(12);
	 * System.out.println("setValue should have changed value only to Q: " + test +
	 * ". Setter returned " + setterTest);
	 * 
	 * setterTest = test.setValue(13);
	 * System.out.println("setValue should have changed value only to K: " + test +
	 * ". Setter returned " + setterTest);
	 * 
	 * // - invalid data (no data change + return false)
	 * setterTest = test.setValue(0);
	 * System.out.println("setValue should NOT have changed value from K: " + test +
	 * ". Setter returned " + setterTest);
	 * 
	 ...
	 * System.out.println("setSuit should have changed suit only to " + Card.DIAMOND
	 * + ": " + test
	 * + ". Setter returned " + setterTest);
	 * 
	 * setterTest = test.setSuit(Card.CLUB);
	 * System.out.println("setSuit should have changed suit only to " + Card.CLUB +
	 * ": " + test
	 * + ". Setter returned " + setterTest);
	 * 
	 * setterTest = test.setSuit(Card.SPADE);
	 * System.out.println("setSuit should have changed suit only to " + Card.SPADE +
	 * ": " + test
	 * + ". Setter returned " + setterTest);
	 * 
	 * setterTest = test.setSuit(Card.HEART);
	 * System.out.println("setSuit should have changed suit only to " + Card.HEART +
	 * ": " + test
	 * + ". Setter returned " + setterTest);
	 * 
	 * // - invalid data (no data change + return false)
	 * setterTest = test.setSuit('H');
	 * System.out.println("setSuit should NOT have changed suit from " + Card.HEART
	 * + ": " + test
	 * + ". Setter returned " + setterTest);
	 * 
...
/*   public static void testSetAll() {
  ...
  System.out.println("setAll should have changed both to A " + Card.DIAMOND +
  ": " + test
  + ". Setter returned " + setterTest);
  
  setterTest = test.setAll(3, Card.SPADE);
  System.out.println("setAll should have changed both to 3 " + Card.SPADE +
  ": " + test
  + ". Setter returned " + setterTest);
  
  setterTest = test.setAll(4, Card.HEART);
  System.out.println("setAll should have changed both to 4 " + Card.HEART +
 ": " + test
  + ". Setter returned " + setterTest);
  
  setterTest = test.setAll(5, Card.CLUB);
  System.out.println("setAll should have changed both to 5 " + Card.CLUB + ": "
  + test
  + ". Setter returned " + setterTest);
  ...
  System.out.
  println("setAll should NOT have changed suit/value from last valid test: " +
  test
  + ". Setter returned " + setterTest);
 ...
 * System.out.println("Full constructor should have built card 6 " +
 * Card.DIAMOND + ": " + test);
 * 
 * test = new Card(7, Card.HEART);
 * System.out.println("Full constructor should have built card 7 " + Card.HEART
 * + ": " + test);
 * 
 * // - invalid data (should shutdown program)
 * // test = new Card(17, Card.CLUB); //should shutdown program, test by
 * uncommenting
...
/* public static void testCopyConstructor() {
	...
	System.out.println("Copy constructor should have built card 5 " + Card.SPADE
			+ ": " + copy);
		System.out.println("Look the same? That's a good start! Need to make sure it's a deep copy!");

		original.setAll(7, Card.DIAMOND);
		System.out.println("Changed original object to 7 " + Card.DIAMOND +
				". Did copy change too? " + copy);
		System.out.println("Copy should have stayed as 5 " + Card.SPADE +
				" to be a deep copy!");
...
/* 	  public static void testGetSuit() {
	  ...
	  System.out.println("getSuit should be default suit " + Card.DEFAULT_SUIT +
	  ": " + test.getSuit());
	  
	  test.setAll(9, Card.SPADE);
	  System.out.println("Changed suit of card, getSuit should be " + Card.SPADE +
	  ": " + test.getSuit());
	  } */
...
/* 		  public static void testGetValue() {
		  ...
		  System.out.println("getValue should be default value " + Card.DEFAULT_VALUE +
		  ": " + test.getValue());
		  
		  test.setAll(8, Card.CLUB);
		  System.out.println("Changed value of card, getValue should be 8: " +
		  test.getValue());
		  } */
...
/* public static void testEquals() {
	...
	System.out.println("Are card " + original + " and card " + test +
			" the same? " + original.equals(test));
